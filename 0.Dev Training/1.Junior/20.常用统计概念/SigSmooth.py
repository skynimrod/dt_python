...
# if you want to see just two window type, comment previous line, and uncomment the following one 
...
def smooth( x, window_len = 11, window = 'hanning' ):
    ...
    window -- type of window: 'flat', 'hanning', 'hamming', 'bartlett', 'balckman'
    ...
    # peck windows type and do averaging
